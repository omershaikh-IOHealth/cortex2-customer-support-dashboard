...
import CircularManagementSection from '@/components/ui/CircularManagementSection'
import {
  Plus,
  Edit,
  Trash2,
...
export default function AdminPage() {
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      showToast(result.message || 'Sync triggered successfully')
    } catch (err) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* ── User Management ──────────────────────────────── */}
      <div className="border-t border-cortex-border pt-6">
        <UserManagementSection />
      </div>

      {/* ── Circulars & Knowledge Base ───────────────────── */}
      <div className="border-t border-cortex-border pt-6">
        <CircularManagementSection />
      </div>
