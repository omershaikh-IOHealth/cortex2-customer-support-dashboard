...
export async function GET(request) {
  try {
    ...
    const params = []
    let query = 'SELECT * FROM main.sla_configs'
...
export async function POST(request) {
  try {
    ...
    const result = await pool.query(`
      INSERT INTO main.sla_configs (solution_id, priority, priority_name, priority_description, response_hours, resolution_hours, resolution_type)
