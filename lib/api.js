...
// Metrics
export const getOverviewMetrics = (company) => api.get('/metrics/overview', { params: company ? { company } : {} }).then(res => res.data)
...
// SLA
export const getCriticalSLA = (company) => api.get('/sla/critical', { params: company ? { company } : {} }).then(res => res.data)

// Escalations
export const getEscalations = (company) => api.get('/escalations', { params: company ? { company } : {} }).then(res => res.data)
...
export const getChannelMix = () => api.get('/analytics/channel-mix').then(res => res.data)
export const getKPISummary = (days = 30) => api.get('/analytics/kpi-summary', { params: { days } }).then(res => res.data)
export const getAgingDistribution = () => api.get('/analytics/aging').then(res => res.data)
export const getTicketsByModule = (days = 30) => api.get('/analytics/by-module', { params: { days } }).then(res => res.data)
export const getDemandHeatmap = (days = 30) => api.get('/analytics/heatmap', { params: { days } }).then(res => res.data)
export const getAgentStats = (days = 30) => api.get('/analytics/agent-stats', { params: { days } }).then(res => res.data)
export const getSentimentDistribution = (days = 30) => api.get('/analytics/sentiment', { params: { days } }).then(res => res.data)

// QA
export const getQAReviews          = (params = {}) => api.get('/qa/reviews', { params }).then(res => res.data)
export const createQAReview        = (data) => api.post('/qa/reviews', data).then(res => res.data)
export const getQAAgentPerformance = (days = 30) => api.get('/qa/agent-performance', { params: { days } }).then(res => res.data)
...
export const getPOC = (id) => api.get(`/admin/pocs/${id}`).then(res => res.data)
...
export const getFlaggedTickets = () => api.get('/qa/flagged').then(res => res.data)
export const flagTicket = (id, reason) => api.post(`/tickets/${id}/flag`, { reason }).then(res => res.data)
export const unflagTicket = (id) => api.delete(`/tickets/${id}/flag`).then(res => res.data)

// Force Sync
export const triggerSync = () => api.post('/admin/sync').then(res => res.data)

// Backfill assignments from ClickUp
export const syncAssignments = () => api.post('/admin/sync-assignments').then(res => res.data)
...
export const updateCallLog = (primaryCallId, data) => api.patch(`/calls/${encodeURIComponent(primaryCallId)}`, data).then(res => res.data)
...
// ============= NEW: ZIWO Stats =============
export const getQueueStats = () => api.get('/ziwo/queue-stats').then(res => res.data)
...
export const createBulkRota = (data) => api.post('/rota/bulk', data).then(res => res.data)
...
export const markAllNotificationsRead = () => api.post('/notifications', { action: 'mark_all_read' }).then(res => res.data)
export const deleteNotification = (id) => api.delete(`/notifications/${id}`).then(res => res.data)
export const clearAllNotifications = () => api.delete('/notifications').then(res => res.data)

// ============= NEW: AI Companion =============
export const sendCompanionMessage = (message, currentPage) => api.post('/companion/chat', { message, currentPage }).then(res => res.data)
...
// ============= NEW: Metrics (AHT, FCR) =============
export const getAHTMetrics = () => api.get('/metrics/aht').then(res => res.data)
export const getFCRMetrics = () => api.get('/metrics/fcr').then(res => res.data)
export const getAgentDashboardMetrics = (params = {}) => api.get('/calls/metrics/agent', { params }).then(res => res.data)

// ============= NEW: Admin sync =============
export const syncCallLogs = () => api.post('/admin/sync-call-logs').then(res => res.data)
export const syncMyCalls = () => api.post('/calls/sync').then(res => res.data)

// ============= Ticket Tags =============
export const getTicketTags = () => api.get('/tickets/tags').then(res => res.data)
export const addTagToTicket = (id, tag) => api.post(`/tickets/${id}/tags`, { tag }).then(res => res.data)

// ============= Leave Requests =============
export const getLeaveTypes = () => api.get('/leave-types').then(res => res.data)
export const getLeaveRequests = (all = false) => api.get(`/leave-requests${all ? '?all=true' : ''}`).then(res => res.data)
export const createLeaveRequest = (data) => api.post('/leave-requests', data).then(res => res.data)
export const reviewLeaveRequest = (id, data) => api.put(`/leave-requests/${id}`, data).then(res => res.data)

// ============= Shift Swaps =============
export const getShiftSwaps = (all = false) => api.get(`/shift-swaps${all ? '?all=true' : ''}`).then(res => res.data)
export const createShiftSwap = (data) => api.post('/shift-swaps', data).then(res => res.data)
export const respondToSwap = (id, response) => api.put(`/shift-swaps/${id}/respond`, { response }).then(res => res.data)
export const reviewShiftSwap = (id, data) => api.put(`/shift-swaps/${id}/review`, data).then(res => res.data)

// ============= Break Requests =============
export const getBreakRequests = (all = false) => api.get(`/break-requests${all ? '?all=true' : ''}`).then(res => res.data)
export const createBreakRequest = (data) => api.post('/break-requests', data).then(res => res.data)
export const reviewBreakRequest = (id, status) => api.put(`/break-requests/${id}`, { status }).then(res => res.data)

// ============= Circular Acks =============
export const getCircularAcks = () => api.get('/circulars/acks').then(res => res.data)
export const acknowledgeCirculars = (circular_ids) => api.post('/circulars/acks', { circular_ids }).then(res => res.data)

// ============= Rota Acknowledge =============
export const acknowledgeShifts = (shift_ids) => api.post('/rota/acknowledge', { shift_ids }).then(res => res.data)
export const getShiftAcks = () => api.get('/rota/acknowledge').then(res => res.data)

// ============= Admin Settings =============
export const getSystemSettings = () => api.get('/admin/settings').then(res => res.data)
export const updateSystemSettings = (data) => api.put('/admin/settings', data).then(res => res.data)

// ============= Call Dispositions =============
export const getDispositions = () => api.get('/admin/dispositions').then(res => res.data)
export const createDisposition = (name) => api.post('/admin/dispositions', { name }).then(res => res.data)
export const deleteDisposition = (id) => api.delete(`/admin/dispositions/${id}`).then(res => res.data)
